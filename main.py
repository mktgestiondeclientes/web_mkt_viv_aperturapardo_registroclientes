...
async def register_event(
    ...
    celular: str = Form(...),
    email: str = Form(...),
    fecha_evento_seleccionada: str = Form(...),
    ...
    USING (
        SELECT
            ...
            @celular AS CELULAR,
            @email AS EMAIL,
            @evento AS FECHA_EVENTO_SELECCIONADA,
    ...
    WHEN MATCHED THEN
      UPDATE SET
        ...
        CELULAR = S.CELULAR,
        EMAIL = S.EMAIL,
        FECHA_EVENTO_SELECCIONADA = S.FECHA_EVENTO_SELECCIONADA,
    ...
    job = client.query(query, job_config=bigquery.QueryJobConfig(
        query_parameters=[
            ...
            bigquery.ScalarQueryParameter("evento", "STRING", fecha_evento_seleccionada),
